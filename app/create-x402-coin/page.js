  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (file) {
        ...
        const metadata = {
          name,
          description: 'A purrfect x402 coin created via catcaster.xyz',
          image: imageUri,
        }
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="mt-8 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <a href="https://catcaster.xyz" target="_blank" rel="noopener noreferrer" className="flex items-center bg-background p-3 rounded border border-border text-accent hover:bg-accent hover:text-background transition">
