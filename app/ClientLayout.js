        ...
        <main className="flex-1">
          <header className="flex justify-center items-center p-4 border-b border-border relative">
            ...
            <div className="flex items-center gap-2 flex-1 justify-center md:justify-between max-w-7xl mx-auto">
              ...
              {/* Right-side button - exactly the same position/placement as ConnectWallet */}
              {pathname === '/' ? (
                <a
                  href="https://farcaster.xyz/casteragents/0x6fb877f3"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-3 bg-gradient-purple text-white font-bold rounded-lg hover:opacity-90 transition"
                >
                  Verify x402 ID
                </a>
              ) : pathname === '/create-x402-coin' ? (
                <ConnectWallet />
              ) : null}
            </div>
          </header>
